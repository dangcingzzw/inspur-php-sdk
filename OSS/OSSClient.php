...
use OSS\Log\OSSLog;
use OSS\Internal\Common\SdkCurlFactory;
use OSS\Internal\Common\SdkStreamHandler;
 ...
 *
 * @method Model getBucketDomain(array $args = []);
 * @method Model setBucketDomain(array $args = []);
 * @method Model deleteBucketDomain(array $args = []);
 * @method Model getBucketEncryptionConfiguration(array $args = []);
 * @method Model setBucketEncryptionConfiguration(array $args = []);
 * @method Model deleteBucketEncryption(array $args = []);
 * @method Model getObjectLink(array $args = []);
 *
 * @method Model appendObject(array $args = []);
 * @method Model cleanParts(array $args = []);
 *
 ...
 * @method Model listBucketInfo(array $args = []);
 *
 * @method Model putObject(array $args = []);
 * @method Model getObject(array $args = []);
 * @method Model doesObjectExist(array $args = []);
 ...
 * @method Model setObjectMetadata(array $args = []);
