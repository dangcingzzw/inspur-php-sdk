...
class V2RequestResource
{
    public static $RESOURCE_ARRAY = [
        'operations' => [
            'setBucketEncryptionConfiguration' => [
                'httpMethod' => 'PUT',
                'specialParam' => 'encryption',
                'data' => [
                    'xmlRoot' => [
            ...
            //--------------------------------------------------------------
            'getBucketEncryptionConfiguration' => [
                'httpMethod' => 'GET',
                'specialParam' => 'encryption',
                'requestParameters' => [
                    'Bucket' => [
...
//                                            'format' => 'date-time-middle'
        ...
        'aliases' => [
            ...
            'setBucketEncryption' => 'setBucketEncryptionConfiguration',
            'getBucketEncryption' => 'getBucketEncryptionConfiguration',
